...
import { Circle, Copy, Edit2, Eye, EyeOff, Info, LinkIcon, Plus, Save } from "lucide-react"
...
export default function PasswordsScreen({
    ...
    return (
        <>
            <div className="px-2 pb-2 flex-1 overflow-y-auto" ref={containerRef}>
                <div
                ...
                {filteredPasswords.length > 0 && (
                    <Button variant="outline" size="sm" className="w-full mt-2 h-8 text-xs" onClick={() => navigateTo(NavigationScreen.CREATE_PASSWORDS)}>
